...
def index():
    if request.method == 'POST':
        try:
            ...
            product_html = bs(prodRes.text, "html.parser")
            print(product_html)
            ...
            for commentbox in commentboxes:
                ...
                reviews.append(myDict)    #review.append instead of reviews.append

            return render_template('results.html', reviews=reviews[0:(len(reviews)-1)])  #result.html instead of results.html
        except Exception as e:
